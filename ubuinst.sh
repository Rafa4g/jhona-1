...
wget https://raw.githubusercontent.com/ruck18/Painel-web/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/ruck18/Painel-web/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/ruck18/Painel-web/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/ruck18/Painel-web/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/ruck18/Painel-web/main/whatsapp.sh > /dev/null 2>&1
...
wget https://www.dropbox.com/s/3u538gamythn2k9/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/ruck18/Painel-web/main/chave") &>/dev/null
